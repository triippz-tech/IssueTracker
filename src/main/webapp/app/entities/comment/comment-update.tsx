...
export class CommentUpdate extends React.Component<ICommentUpdateProps, ICommentUpdateState> {
  ...
  render() {
    const { commentEntity, issues, users, loading, updating } = this.props;
    const { isNew } = this.state;

    const { description } = commentEntity;

    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="issueTrackerApp.comment.home.createOrEditLabel">Create or edit a Comment</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : commentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="comment-description">
                    Description
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="comment-issue">Issue</Label>
